...
if (useSSL) {
    try {
        ...
        const sslDir = process.env.SSL_DIR || "/etc/letsencrypt/live/makemypackages.com";
        ...
        if (!fs.existsSync(keyPath) || !fs.existsSync(certPath)) {
            ...
            if (isProduction) {
                ...
                console.log("   sudo certbot certonly --standalone -d makemypackages.com");
                console.log("   sudo chown -R $USER:$USER /etc/letsencrypt/live/makemypackages.com/");
