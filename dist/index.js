...
if (useSSL) {
    try {
        ...
        const sslDir = process.env.SSL_DIR || "/etc/letsencrypt/live/api.makemypackages.com";
        ...
        if (!fs.existsSync(keyPath) || !fs.existsSync(certPath)) {
            ...
            if (isProduction) {
                ...
                console.log("   sudo certbot certonly --standalone -d api.makemypackages.com");
                console.log("   sudo chown -R $USER:$USER /etc/letsencrypt/live/api.makemypackages.com/");
        ...
        https.createServer(sslOptions, app).listen(HTTPS_PORT, () => {
            ...
            console.log(`🔒 Secure MakemyPackages Email Scanner Server accessible at:`);
        ...
        if (isProduction) {
            ...
            httpRedirectApp.use((req, res) => {
                ...
                const targetPort = HTTPS_PORT && HTTPS_PORT !== 443 ? `:${HTTPS_PORT}` : "";
