...
(async () => {
    try {
        const publicPdfUrl = "https://travel-images1234.s3.ap-south-1.amazonaws.com/packages/PHU+QUOC+%E2%80%93+DANANG+%E2%80%93+HOI+AN+%E2%80%93+HANOI+%E2%80%93+NINH+BINH+-+HALONG+09+NIGHTS+AND+10+DAYS+VIETNAM+(1)+(1)+(1)+(1).pdf"; // <-- replace this
