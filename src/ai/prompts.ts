export function createMarketingPrompt(): string {
  return `
...
export function createItineraryPrompt(): string {
  return `
...
export function createDailyItineraryPrompt(): string {
  return `
...
export function createPricingPrompt(): string {
  return `
